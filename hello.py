...
BOT_TOKEN = "7750002686:AAEXjT0mL7racKD8SGrc55sTrY4nNoTxDOY"

# Admin password for /pass command
ADMIN_PASSWORD = "IGNITE-xx-PAPA"
...
async def bgmi(update: Update, context: CallbackContext):
    ...
    if user_id not in user_access:
        await update.message.reply_text("⚠️ You don't have access. Please pay ₹100 for 5 days access using /pay. CONTACT @IGNITE_OWNER")
        return
